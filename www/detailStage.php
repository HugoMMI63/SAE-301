...
$apiUrl = "http://localhost:8181/www/API/remplacerContenuStage.php?id=".$stageId;
...
$apiUrl = "http://localhost:8181/www/API/stagesAleatoires.php?id=".$stageId;
$response = file_get_contents($apiUrl);
$data = json_decode($response, true);
...
<html lang="fr">
    ...
    <body>
        ...
        <main>
            ...
            <!-- Bouton pour revenir à la page "nosStages.php" -->
            
            <a href="nosStages.php"><button>Retour à la liste des stages</button></a>
        </main>
        <!-- Ajout du footer -->

            ...
            <section class="container text-center my-5">
                ...
                <form action="executable/modifierStage.php?id=<?php echo $stage[0]['id']; ?>" method="POST">
                    ...
                    <div>
                        ...
                        <input type="text" id="date" name="date" value="<?php echo $stage[0]['date'] ?>" required="required">
                    </div>
                    <br>
                    <div>
                    ...
                    <br>
                    <div>
                        <input class="btn btn-warning fw-bold px-4 py-2" type="submit" value="Modifier le stage">
                    </div>
                </form>
            </section>
        </main>

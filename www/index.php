            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        ...
                        <p class="lead d-none d-md-block">Plonge dans l'univers captivant du théâtre improvisé cet automne et libère ta créativité sur scène. Découvre des jeux scéniques drôles, dynamiques et pleins de surprises durant ce stage unique !</p>
                        <a href="details_stage.php?id=1"><button value="1" type="button" class="btn-yellow">DÉCOUVRIR LE STAGE</button></a>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-md-block bg-dark bg-opacity-50 rounded p-3">
                        ...
                        <p class="lead d-none d-md-block">Découvre l'art fascinant de la sérigraphie cet automne et crée des œuvres uniques avec tes propres mains ! Laisse libre cours à ton imagination lors de ce stage créatif !</p>
                        <a href="details_stage.php?id=3"><button value="3" type="button" class="btn-yellow">DÉCOUVRIR LE STAGE</button></a>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-md-block bg-dark bg-opacity-50 rounded p-3">
                        ...
                        <p class="lead d-none d-md-block">La Ka'fête ô mômes ouvre ses portes aux gourmands ! Cet été, mets la main à la pâte et explore l'art de la cuisine dans un stage gourmand et plein de saveurs ! Rejoins nous vite !</p>
                        <a href="details_stage.php?id=4"><button value="4" type="button" class="btn-yellow">DÉCOUVRIR LE STAGE</button></a>
                    </div>
                </div>
            ...
            <section class="container my-5">
                <div class="row align-items-center">
                    <div class="col-md-6 text-start">
                        ...
                        <a href="nos_stages.php"><button class="btn-yellow">DÉCOUVRIR NOS STAGES ></button></a>
                    </div>
            ...
            <section class="container my-5">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 text-start">
                        ...
                        <a href="nos_animateurs.php"><button class="btn-yellow">DECOUVRIR NOS ANIMATEURS ></button></a>
                    </div>
                </div>
            </section>

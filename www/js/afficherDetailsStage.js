// Fonction pour remplacer le contenu de la page detailstage par un autre + 3 nouveaux stages générés aléatoirement
	...
	xhttp2.onreadystatechange = function() {
		if (this.readyState == 4 && this.status == 200) {
			...
			if(response.status=="OK"){
                ...
                // Mise à jour de la section des autres stages
